...
class AppSettings(object):
    ...
    def INVITATION_ONLY(self):
        ...
        return self._setting('INVITATION_ONLY', True)
    ...
    def SIGNUP_REDIRECT(self):
        ...
        return self._setting('SIGNUP_REDIRECT', 'register')

    @property
    def LOGIN_REDIRECT(self):
        """ Where to redirect on an expired or already accepted invite """
        return self._setting('LOGIN_REDIRECT', settings.LOGIN_REDIRECT_URL)
    ...
    def EMAIL_SUBJECT_PREFIX(self):
        ...
        """
        return self._setting("EMAIL_SUBJECT_PREFIX", "")
